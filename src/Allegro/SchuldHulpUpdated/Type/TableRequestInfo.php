...
class TableRequestInfo
{
     ...
     */
    private \GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulpUpdated\Type\DataParameterArray $Parameters;
     ...
     */
    public function getParameters(): \GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulpUpdated\Type\DataParameterArray
    {
     ...
     * @return static
     */
    public function withParameters(\GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulpUpdated\Type\DataParameterArray $Parameters): static
    {
        $new = clone $this;
