...
class eSoortInkomen
{
    const __default = 'Werk';
    const Werk = 'Werk';
    const Uitkering = 'Uitkering';
    const Combinatie_werk_en_uitkering = 'Combinatie_werk_en_uitkering';
    const Studiefinanciering = 'Studiefinanciering';
    const Pensioen = 'Pensioen';
