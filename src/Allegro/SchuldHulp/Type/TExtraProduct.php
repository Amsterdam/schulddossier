...
class TExtraProduct implements RequestInterface
{
     ...
     */
    private \GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulp\Type\TExtraProductHeader $InfoHeader;
     ...
     */
    public function __construct(\GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulp\Type\TExtraProductHeader $InfoHeader, string $Medewerker, int $Opdrachtgever, int $OpdrachtgeverContact, \DateTimeInterface $Startdatum, string $Status, string $StatusOmschrijving, int $UitvoerendeOrganisatie, int $UitvoerendeOrganisatieContact, \DateTimeInterface $GeschatteEinddatum, int $PartnerCode)
    {
     ...
     */
    public function getInfoHeader() : \GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulp\Type\TExtraProductHeader
    {
     ...
     * @return static
     */
    public function withInfoHeader(\GemeenteAmsterdam\FixxxSchuldhulp\Allegro\SchuldHulp\Type\TExtraProductHeader $InfoHeader) : static
    {
        $new = clone $this;
