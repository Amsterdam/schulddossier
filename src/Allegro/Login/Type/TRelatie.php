...
class TRelatie implements RequestInterface
{
     ...
     * @var \GemeenteAmsterdam\FixxxSchuldhulp\Allegro\Login\Type\KindArray $Kinderen
     * @var int $Bedrijf
     * @var string $IBAN
     * @var string $BIC
     ...
     * @var \GemeenteAmsterdam\FixxxSchuldhulp\Allegro\Login\Type\TMedewerker $Klantmanager
     * @var string $Pincode
     */
