...
class DossierFormLabel
{
    public const DOSSIER_FORM_LABELS = [
        ...
        'jssAdviseurNaam' => 'Naam Jongerenadviseur/-coach',
        'jssAdviseurTelefoon' => 'Telefoonnummer Jongerenadviseur/-coach',
        'jssAdviseurEmail' => 'E-mailadres Jongerenadviseur/-coach',
